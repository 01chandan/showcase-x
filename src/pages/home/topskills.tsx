...
const SkillCard: React.FC<{ skill: Skill }> = ({ skill }) => {
    ...
    return (
        ...
        >
            ...
            <span className="relative z-10 text-[16.2px] font-semibold text-[#ffffff] group-hover:text-white transition-colors duration-300">
                {skill.name}
            </span>
        </motion.div>
    );
